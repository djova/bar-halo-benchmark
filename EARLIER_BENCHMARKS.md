# Earlier benchmarks: instructions and recorded verification

These are retained instructions from the preceding release. For the current
population result and reproduction status, start at [the overview](README.md).
