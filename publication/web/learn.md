...
[Explore the recorded populations — historical website-only](https://djova.ca/galaxy-bar/population-response.html#population-explorer) · [Expert model and normalization](https://raw.githubusercontent.com/djova/bar-halo-benchmark/publication-2026-09-24.1/publication/web/paper.md#model) · [Next: transfer](#learn-3)
...
[Follow the same recorded orbit and torque — historical website-only](https://djova.ca/galaxy-bar/response-coupling.html) · [Expert observable](https://raw.githubusercontent.com/djova/bar-halo-benchmark/publication-2026-09-24.1/publication/web/paper.md#model) · [Next: resonances](#learn-4)
...
[Recorded resonance trajectories — historical website-only](https://djova.ca/galaxy-bar/noise-sweep.html#paths) · [Expert local model](https://raw.githubusercontent.com/djova/bar-halo-benchmark/publication-2026-09-24.1/publication/web/paper.md#model) · [Next: noise and inference](#learn-5)
...
[Retained correction and synthetic controls — historical website-only](https://djova.ca/galaxy-bar/response.html) · [Expert uncertainty](https://raw.githubusercontent.com/djova/bar-halo-benchmark/publication-2026-09-24.1/publication/web/paper.md#accuracy) · [Next: the contribution](#learn-6)
...
[Read the complete article](https://raw.githubusercontent.com/djova/bar-halo-benchmark/publication-2026-09-24.1/publication/web/paper.md) · [Check the evidence yourself](https://raw.githubusercontent.com/djova/bar-halo-benchmark/publication-2026-09-24.1/publication/web/reproduce.md)
