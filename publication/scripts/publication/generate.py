...
VERSION='2026-09-23.1'; SCIENCE='cdb30b5b2f350d2f3de6831995b83f281fe2974e'
...
def render(s): return markdown.markdown(s,extensions=['tables','fenced_code','attr_list','md_in_html'])
